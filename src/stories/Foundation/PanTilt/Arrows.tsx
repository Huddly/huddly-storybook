...
const Arrows = ({ x, y, scale }: Props) => {
  ...
  return (
    <g fill='white'>
      <StyledPath
        id='arrowDown'
        transform={getArrowTransformation(realCenterX, realCenterY + spaceBetweenArrows, scale)}
      ...
      <StyledPath
        id='arrowLeft'
        transform={getArrowTransformation(realCenterX - spaceBetweenArrows, realCenterY, scale)}
