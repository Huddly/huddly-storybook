...
const Styled = __importStar(require("../Select/styled"));
// Custom hooks
const index_1 = require("../../../shared/hooks/index");
// Utility functions
const select_utils_1 = require("../Select/select-utils");
/**
 * Select component
 */
exports.MultiSelect = react_1.default.forwardRef((props, ref) => {
     ...
     */
    (0, index_1.useOnClickOutside)(selectWrapperRef, () => setIsOpen(false));
    /**
