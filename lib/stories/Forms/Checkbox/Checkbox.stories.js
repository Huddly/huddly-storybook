...
exports.MultipleCheckboxes = exports.HasSuccess = exports.HasError = exports.HasWarning = exports.HasHint = exports.Checked = exports.Primary = void 0;
...
exports.Checked = {
    args: Object.assign(Object.assign({}, exports.Primary.args), { checked: true }),
};
const Template = ({ severity, severityMessage, children, id, isRequired, loading }) => {
    return ((0, jsx_runtime_1.jsx)(index_1.InputWrapper, Object.assign({ severity: severity, severityMessage: severityMessage, id: id, isRequired: isRequired }, { children: (0, jsx_runtime_1.jsx)(_1.Checkbox, Object.assign({ loading: loading }, { children: children })) })));
};
...
const Multiple = ({ severity, severityMessage, id, isRequired, loading }) => {
    return ((0, jsx_runtime_1.jsxs)(index_1.InputWrapper, Object.assign({ severity: severity, severityMessage: severityMessage, id: id, isRequired: isRequired, loading: loading }, { children: [(0, jsx_runtime_1.jsx)(index_1.Label, { children: "This label automatically gets transformed into a Fieldset legend! \uD83E\uDD2F" }), (0, jsx_runtime_1.jsx)(_1.Checkbox, Object.assign({ value: 'one' }, { children: "One" })), (0, jsx_runtime_1.jsx)(_1.Checkbox, Object.assign({ value: 'two' }, { children: "Two" })), (0, jsx_runtime_1.jsx)(_1.Checkbox, Object.assign({ value: 'three' }, { children: "Three" }))] })));
};
exports.MultipleCheckboxes = Multiple.bind({});
exports.MultipleCheckboxes.args = Object.assign(Object.assign({}, exports.Primary.args), { severity: 'info', severityMessage: 'Same pulchritudinous API for everything' });
